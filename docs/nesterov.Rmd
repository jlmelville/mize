...
The CM expression for $\theta_4$ re-written to use $m_t$ is the only example we
need:
...
\begin{equation}
\begin{split}
\theta_4 & = \theta_3 + s_3 + \mu m_4 \\
 & = \theta_3 + s_3 + \mu \left( s_3 + \mu s_2 + \mu^2 s_1 + \mu^3 s_0 \right) \\
 & = \theta_3 + \left( 1 + \mu \right) s_3 + \mu^2 s_2 + \mu^3 s_1 + \mu^4 s_0
\end{split}
\end{equation}
$$
...
$$
\theta_4 = \theta_3 + \left(1 + \mu \right) s_3 + \mu^2 s_2 + \mu^3 s_1 + \mu^4 s_0
$$
