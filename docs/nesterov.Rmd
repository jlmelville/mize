...
\right]
$$
where the first two terms look like the classical momentum expression, which 
suggests we can create a "generalized" momentum update by introducing a parameter
$\beta$ to give:
