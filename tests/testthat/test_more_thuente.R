...
test_that("Table 1", {
  ...
  res11 <- mtls(fg = f1, x = 0, pv = pv1, alpha = 1e-3, c1 = 0.001, c2 = 0.1)
  expect_step(res11, x = 1.3650, f = -0.35333, df = -0.0091645, alpha = 1.3650, nfev = 6)
  res12 <- mtls(fg = f1, x = 0, pv = pv1, alpha = 1e-1, c1 = 0.001, c2 = 0.1)
  expect_step(res12, x = 1.4414, f = -0.35349, df = 0.0046645, alpha = 1.4414, nfev = 3)
  res13 <- mtls(fg = f1, x = 0, pv = pv1, alpha = 1e1, c1 = 0.001, c2 = 0.1)
  expect_step(res13, x = 10, f = -0.098039, df =  0.0094195, alpha = 10, nfev = 1)
  res14 <- mtls(fg = f1, x = 0, pv = pv1, alpha = 1e3, c1 = 0.001, c2 = 0.1)
...
test_that("Table 2", {
  ...
  # # gradient 7.1e-9
  res21 <- mtls(fg = f2, x = 0, pv = pv2, alpha = 1e-3, c1 = 0.1, c2 = 0.1)
  ...
  res22 <- mtls(fg = f2, x = 0, pv = pv2, alpha = 1e-1, c1 = 0.1, c2 = 0.1)
  expect_step(res22, x = 1.5960, f = -2.6214, df = 1.0106e-010, alpha = 1.5960, nfev = 8)
  res23 <- mtls(fg = f2, x = 0, pv = pv2, alpha = 1e1, c1 = 0.1, c2 = 0.1)
  expect_step(res23, x = 1.5960, f = -2.6214, df = -4.9725e-009, alpha = 1.5960, nfev = 8)
  res24 <- mtls(fg = f2, x = 0, pv = pv2, alpha = 1e3, c1 = 0.1, c2 = 0.1)
...
test_that("Table 3", {
  ...
  res31 <- mtls(fg = f3, x = 0, pv = pv3, alpha = 1e-3, c1 = 0.1, c2 = 0.1)
  expect_step(res31, x = 1.0, f = -0.011160, df = -5.1440e-005, alpha = 1.0, nfev = 12)
  res32 <- mtls(fg = f3, x = 0, pv = pv3, alpha = 1e-1, c1 = 0.1, c2 = 0.1)
  expect_step(res32, x = 1.0, f = -0.011160, df = -1.9224e-004, alpha = 1.0, nfev = 12)
  res33 <- mtls(fg = f3, x = 0, pv = pv3, alpha = 1e1, c1 = 0.1, c2 = 0.1)
  expect_step(res33, x = 1.0, f = -0.011160, df = -1.9892e-006, alpha = 1.0, nfev = 10)
  res34 <- mtls(fg = f3, x = 0, pv = pv3, alpha = 1e3, c1 = 0.1, c2 = 0.1)
...
test_that("Table 4", {
  ...
  # alpha = 0.08
  res41 <- mtls(fg = f4, x = 0, pv = pv4, alpha = 1e-3, c1 = 0.001, c2 = 0.001)
  expect_step(res41, x = 0.085, f = 0.99901, df = -6.8531e-005, alpha = 0.085, nfev = 4)
  res42 <- mtls(fg = f4, x = 0, pv = pv4, alpha = 1e-1, c1 = 0.001, c2 = 0.001)
  expect_step(res42, x = 0.1, f = 0.99901, df = -4.9330e-005, alpha = 0.1, nfev = 1)
  res43 <- mtls(fg = f4, x = 0, pv = pv4, alpha = 1e1, c1 = 0.001, c2 = 0.001)
  expect_step(res43, x = 0.34910, f = 0.999, df = -2.9195e-006, alpha = 0.34910, nfev = 3)
  res44 <- mtls(fg = f4, x = 0, pv = pv4, alpha = 1e3, c1 = 0.001, c2 = 0.001)
...
test_that("Table 6", {
  ...
  res61 <- mtls(fg = f6, x = 0, pv = pv6, alpha = 1e-3, c1 = 0.001, c2 = 0.001)
  expect_step(res61, x = 0.9279, f = 0.99139, df = 5.2203e-004, alpha = 0.9279, nfev = 13)
  res62 <- mtls(fg = f6, x = 0, pv = pv6, alpha = 1e-1, c1 = 0.001, c2 = 0.001)
  expect_step(res62, x = 0.92615, f = 0.99138, df = 8.3588e-005, alpha = 0.92615, nfev = 11)
  res63 <- mtls(fg = f6, x = 0, pv = pv6, alpha = 1e1, c1 = 0.001, c2 = 0.001)
  expect_step(res63, x = 0.92478, f = 0.99138, df = -2.3788e-004, alpha = 0.92478, nfev = 8)
  res64 <- mtls(fg = f6, x = 0, pv = pv6, alpha = 1e3, c1 = 0.001, c2 = 0.001)
...
test_that("Function modification", {
  res4m <- mtls(fg = f4, x = 1, pv = -f4$gr(1)/abs(f4$gr(1)), alpha = 1, c1 = 0.1, c2 = 0.9)
  expect_step(res4m, x = 0.99615, f = 0.99913, df = 0.032049, alpha = 0.0038522, nfev = 6)
  res5m <- mtls(fg = f5, x = 1, pv = -f5$gr(1)/abs(f5$gr(1)), alpha = 1, c1 = 0.1, c2 = 0.9)
  expect_step(res5m, x = 0.99599, f = 0.99914, df = 0.038284, alpha = 0.0040126, nfev = 6)
  res6m <- mtls(fg = f6, x = 1, pv = -f6$gr(1)/abs(f6$gr(1)), alpha = 1, c1 = 0.1, c2 = 0.9)
