...
test_that("Table 1", {
  ...
  res11 <- rls(fg = f1, x = 0, pv = pv1, alpha = 1e-3, c1 = 0.001, c2 = 0.1)
  expect_step(res11, x = 1.2132, f = -0.34944, df = -0.043803, alpha = 1.2132, nfev = 9)
  res12 <- rls(fg = f1, x = 0, pv = pv1, alpha = 1e-1, c1 = 0.001, c2 = 0.1)
  expect_step(res12, x = 1.2531, f = -0.35098, df = -0.033723, alpha = 1.2531, nfev = 5)
  res13 <- rls(fg = f1, x = 0, pv = pv1, alpha = 1e1, c1 = 0.001, c2 = 0.1)
  expect_step(res13, x = 10, f = -0.098039, df =  0.0094195, alpha = 10, nfev = 1)
  res14 <- rls(fg = f1, x = 0, pv = pv1, alpha = 1e3, c1 = 0.001, c2 = 0.1)
...
test_that("Table 3", {
  ...
  res31 <- rls(fg = f3, x = 0, pv = pv3, alpha = 1e-3, c1 = 0.1, c2 = 0.1)
  expect_step(res31, x = 1.0, f = -0.011160, df = 2.3645e-006, alpha = 1.0, nfev = 18)
  res32 <- rls(fg = f3, x = 0, pv = pv3, alpha = 1e-1, c1 = 0.1, c2 = 0.1)
  expect_step(res32, x = 1.0, f = -0.011160, df = -3.8131e-006, alpha = 1.0, nfev = 15)
  res33 <- rls(fg = f3, x = 0, pv = pv3, alpha = 1e1, c1 = 0.1, c2 = 0.1)
  expect_step(res33, x = 1.0, f = -0.011160, df = -4.1227e-015, alpha = 1.0, nfev = 2)
  res34 <- rls(fg = f3, x = 0, pv = pv3, alpha = 1e3, c1 = 0.1, c2 = 0.1)
...
test_that("Table 4", {
  ...
  res41 <- rls(fg = f4, x = 0, pv = pv4, alpha = 1e-3, c1 = 0.001, c2 = 0.001)
  expect_step(res41, x = 0.023344, f = 0.99902, df = -9.1485e-004, alpha = 0.023344, nfev = 13)
  res42 <- rls(fg = f4, x = 0, pv = pv4, alpha = 1e-1, c1 = 0.001, c2 = 0.001)
  expect_step(res42, x = 0.1, f = 0.99901, df = -4.9330e-005, alpha = 0.1, nfev = 1)
  res43 <- rls(fg = f4, x = 0, pv = pv4, alpha = 1e1, c1 = 0.001, c2 = 0.001)
  expect_step(res43, x = 0.47507, f = 0.999002, df = -4.0043e-007, alpha = 0.47507, nfev = 3)
  res44 <- rls(fg = f4, x = 0, pv = pv4, alpha = 1e3, c1 = 0.001, c2 = 0.001)
