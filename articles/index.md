...
- [Nesterov Accelerated Gradient and
  ...
  Background notes on Nesterov accelerated gradient and its relationship
  to momentum methods.

- [Quasi-Hyperbolic
  Momentum](https://jlmelville.github.io/mize/articles/qhm.md):

  Background notes connecting quasi-hyperbolic momentum to classical and
  Nesterov momentum.
